...
namespace PrologueGameplayTags
{
	...
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Comma_State_FirstHit);

	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Comma_State_MainCharacter);
	...
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_ChronosAura);
	...
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Chronos_Event_Spawnlino);
	...
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Chronos_State_IsInSecondPhase);
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Chronos_State_Invincible);
	PROLOGUE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Chronos_State_Boss);
