...
AEggBallProjectile::AEggBallProjectile()
{
...
void AEggBallProjectile::FireInDirection(const FVector& ShootDirection) const
{
	ProjectileMovement->Velocity = ShootDirection * ProjectileMovement->InitialSpeed;
}

void AEggBallProjectile::BeginPlay()
{
	Super::BeginPlay();
...
void AEggBallProjectile::OnProjectileHit(UPrimitiveComponent* HitComponent, AActor* OtherActor,
...
void AEggBallProjectile::OnProjectileBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
	UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	// 투사체끼리의 충돌 무시
	if (Cast<AEggBallProjectile>(OtherActor))
	{
		return;
	}
